...
/** Nut lien he noi (goc phai duoi) — Goi / Messenger / Zalo. Hien tren moi trang gian hang. */
export default function ShopFab() {
  return (
    <div className="fixed bottom-24 right-3 z-40 flex flex-col items-center gap-3 md:bottom-6 md:right-5">
      {/* Goi dien */}
      <a href="tel:0376533857" aria-label="Gọi điện" className="relative flex h-12 w-12 items-center justify-center rounded-full bg-green-500 text-white shadow-lg">
      ...
      {/* Messenger */}
      <a href="https://www.facebook.com/xuonggaubaobao99" target="_blank" rel="noreferrer" aria-label="Messenger"
      ...
      {/* Zalo */}
      <a href="https://zalo.me/0376533857" target="_blank" rel="noreferrer" aria-label="Zalo"
